/**
 * Generated Supabase types for the previous project schema.
 * When the new database is ready, regenerate (e.g. Supabase CLI) and replace this file.
 */
export type Json =
  | string
  | number
...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      /** GHL mirror (see docs/database/migrations/003). Extend Row when regenerating types from Supabase. */
      ghl_contacts: {
        Row: {
          id: string
